...
## Recipe: configure the Hermes log watchdog

The following operational instructions are retained from the former `examples/bootstrap-shared/POST_SETUP.md`. Use this recipe when the installed Hermes runtime should monitor its logs and deliver reviewed alerts.
