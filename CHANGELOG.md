...
- Aligns Agent and Dashboard readiness probing with the existing 90-second liveness startup window so ordinary full-stack restart/reinstall startup does not emit connection-refused Warning Events before their sockets listen.
