...
- Delays Agent and Dashboard readiness probing to 60 seconds—still below the existing 90-second liveness delay—so ordinary full-stack restart/reinstall startup does not emit connection-refused Warning Events before their sockets listen.
