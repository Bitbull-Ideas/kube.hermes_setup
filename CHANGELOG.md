...
- Delays Agent and Dashboard readiness probing to 30 seconds so ordinary restart/reinstall startup does not emit connection-refused Warning Events before their sockets listen.
