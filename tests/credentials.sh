...
grep -Fq 'Dashboard/WebUI password: dashboard-secret' "$show_output"
grep -Fq 'API server key: api-secret' "$show_output"
grep -Fq 'Browserless token: browser-secret' "$show_output"
